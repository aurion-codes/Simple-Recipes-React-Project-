   ...
   const diffFoods= [
  ...
  
      {
        ...
        "instructions":"After thawing, drain the fat off of the crawfish; reserve the fat. Roughly chop the crawfish; set aside.Melt butter in a pan. Add in the onions, bell pepper, celery, and garlic.Sauté for 2-3 minutesAdd in the crawfish fat, liquid crab boil, 1 TBS Cajun/creole seasoning, and onion powder. Stir and simmer for 3 minutes.Add in the crawfish tails and stir until crawfish are warm; about 2 minutes. Do not overcook.Turn off the heat and remove the pan from the stove. Stir in 1 cup of the breadcrumbs and all of the green onions into the mixture.Allow the mixture to cool to room temperature.Create a breading station by whisking the egg and milk in a bowl. Next, pour the flour in one shallow dish and mix 1 TBS of Cajun seasoning into the flour. Add the remaining 1 cup of breadcrumbs into another shallow dish. When the crawfish mixture has cooled, form it into 1 inch balls. Heat oil to 350°F for frying. Dredge each ball into the flour, then the egg wash, and finally into the breadcrumbs.Fry the balls for 3 mins or until golden brown. Drain on a wired rack.",
          "image":"https://i0.wp.com/coopcancook.com/wp-content/uploads/2016/05/bmc_4523.jpg?resize=1536%2C1024&ssl=1",
          "calories":400
      },
  
      {
        "id":9,
        "name":"Spring Chicken Tray With Green Vegetables",
        "ingredients": "2 peppers, deseeded and roughly chopped.2 medium-sized sweet potatoes, cut into 2cm pieces1 red onion, finely chopped. 2 courgettes, roughly chopped. 2tbsp extra virgin olive oil, plus extra to brush. 200g mushrooms, roughly chopped. 250g pack ready-to-eat puy lentils. 3tbsp green olive tapenade. Small handful of fresh parsley or oregano, roughly chopped,5 filo pastry sheets, each measuring about 32 x 38cm",
        "instructions":"Heat the oven to 200°C or Gas Mark 6. Put the peppers, sweet potato, onion and courgettes in a large roasting tin. Toss through the oil and season well. Roast the vegetables in the oven for 15 mins, turning them to coat. Add the mushrooms and cook for 15 mins more. Set aside to cool completely. Rinse the lentils and stir through the tapenade and parsley or oregano. Check the seasoning and gently mix with the roasted vegetables. Heat the oven to 200°C or Gas Mark 6. Brush one side of each sheet of filo pastry with oil then arrange, oil-side down, in the springform tin, leaving no gaps at the base or sides let the excess filo hang over the edges.Spoon the vegetable filling into the pastry and press down firmly to level. Cover the filling with the overhanging pastry, scrunching it up. Bake the pie in the oven for 20 mins, then unclip and remove the metal rim. Bake for 10-15 mins more, until deep golden.",
        "image":"https://keyassets-p2.timeincuk.net/wp/prod/wp-content/uploads/sites/63/2017/04/vegetarian-filo-pie-scaled.jpg",
        "calories":303
      },
  
      {
        "id": 10,
        "name":"spring chciken tray bake with green vegatables",
        "ingredients":"2 tbsp olive oil, 6 small skin-on chicken thighs, 150ml chicken stock,6 spring onions,100g Tenderstem broccoli,100 sugar snaps, 1 lemon quartered, small handful oregano, 500g new potatoes to serve",
        "instructions":"Heat the oven to 180C, gas 4. Heat the oil in a flameproof and ovenproof dish on the hob until hot. Carefully add  the chicken thighs, skin side down, and cook for 4-5 minutes until golden and crisp.Remove from the hob and carefully pour over the stock and place in the oven for 15 minutes.Remove the chicken from the oven and add the vegetables and lemon quarters to the pan, making sure to coat them in the stock, and season well. Return to the oven for 10 minutes, until the chicken is cooked through and the vegetables are just tender. Scatter with oregano and serve with new potatoes.",
        "image":"https://keyassets-p2.timeincuk.net/wp/prod/wp-content/uploads/sites/63/2016/05/spring-chicken-traybake-1024x647.jpg",
        "Calories":270
      },
      {
        "id": 11,
        "name":"Wholewheat Spaghetti with Roasted Veg",
        "ingredients":" 4 baby aubergines,2 courgettes, sliced 4tbsp olive oil,500g wholewheat spaghetti,Zest and juice 2 lemons,1⁄2 x 30g packet basil,1⁄2 x 30g packet mint",
        "instructions":"Heat the oven to 200C, gas 6. Toss the veg in 2tbsp olive oil and put onto a lined baking tray. Roast for 10-15    mins until just crisp. Remove from the oven and allow to cool. Meanwhile, cook the spaghetti according to pack instructions. Drain well, then toss with the remaining olive oil, the lemon juice, roasted vegetables and most of the basil and mint.Pour onto a serving platter and scatter over lemon zest and the remaining herbs to serve.",
        "image":"https://keyassets-p2.timeincuk.net/wp/prod/wp-content/uploads/sites/63/2018/07/Wholewheat-spaghetti-with-roasted-veg-scaled.jpg",
        "calories": 379
      },
      {
        "is": 2,
        ...
        "image":"https://keyassets-p2.timeincuk.net/wp/prod/wp-content/uploads/sites/63/2018/07/Lemon-chicken-and-rice-stir-fry-scaled.jpg",
        "calories":216
      },
      {
        "id": 13,
        "name":"Spicy-Pepper-Pulled-Pork",
        "ingredients":"5kg boneless pork shoulder.1 pack Bart Smokehouse Barbecue Chipotle Rub.1tsp coarse black pepper,1tbsp oil,8tbsp ketchup, 4tbsp cider vinegar,2tbsp Worcestershire sauce,1tbsp honey",
        "instructions":"Heat the oven to 220C, gas 7. Rub the pork skin with the chipotle mix, black pepper and oil. Put the pork onto a rack in a roasting tin and roast for 1 hr.Meanwhile, mix together the ketchup, vinegar, Worcestershire sauce and honey.Skim off any fat from the roasting pan juices and remove the crackling from the pork, then set aside. Pour the ketchup mixture around the pork and cover the tin with foil. Turn the oven down to 150C, gas 3 and continue to cook for 4hrs, or cook on a BBQ for an extra smoky flavour.Put the cooked pork on a board and using two forks, shred the meat into small pieces. Stir the shredded meat back into the cooking juices, which should have reduced to a sauce.Serve the meat piled into baked sweet potatoes or burger buns with crackling, coleslaw and a rocket salad, garnished with sliced chilli and some spring onion",
        "image":"https://keyassets-p2.timeincuk.net/wp/prod/wp-content/uploads/sites/63/2015/07/pulled-pork-scaled.jpg",
        "calories":465
      },
      {
        "id":14,
        "name": "Moroccan-Chicken-Salad",
        "ingredients":"2 chicken breasts, about 150g each.4tsps olive oil,2tsps harissa paste, 6 baby courgettes, each sliced into 3 pieces lengthways,4 slices of ciabatta,2 handfuls of watercress,180g packet griddled artichokes in oil,16 green olives,1tbsp balsamic vinegar,Handful of garlic chives, optional",
        "instructions":"Put the chicken breasts between 2 sheets of cling film and bash with a rolling pin until the meat is about 1cm thick.Rub 2tsps of oil over the chicken, then the harissa paste. Heat a griddle pan until very hot. Rub the rest of the oil over the courgette slices and grill until tender.Wipe any excess paste off the chicken and grill the breasts for 3-4 minutes on each side. Take out of the pan and wrap in foil. Griddle the slices of ciabatta.Divide the watercress, chunks of ciabatta, courgettes, artichokes and olives between 4 plates. Slice the chicken and arrange on top. Whisk 3tbsps of oil from the pack of artichokes with the balsamic vinegar and drizzle over the salad. Scatter with garlic chives, if you like.",
        "image":"https://keyassets-p2.timeincuk.net/wp/prod/wp-content/uploads/sites/63/2019/06/Moroccan-chicken-salad.jpg",
        "calories":236
      },
      {
        "id":15,
        "name":"Meatballs-with-lemon-tagliatelle",
        "ingredients":" 25-250g 7½-8oz veal, pork or turkey mince 1 lemon ½ tsp herbes de provence, optional Salt and freshly ground black pepper 2 tsp vegetable oil 150g 5oz tagliatelle 1 courgette.Knob of butter.Pinch of dried chilli flakes, optional.2-3 tbs crème fraîche or half-fat crème fraîche",
        "instructions":"Put the mince into a large bowl and grate in zest from half the lemon and add the herbs, if using, and season well. Heat the oil in a pan and add small portions of meat about 14, roughly clumped together, and cook them over a med heat, without moving them in the pan for 5 mins. Flip them over and cook for another couple of mins, or until browned all over. Tip them out into an ovenproof dish and keep them warm in the oven on a low temperature. Meanwhile, add the pasta to a pan of boiling water and cook for 6 mins.Cut the ends off the courgette and use a vegetable peeler to pare it into ribbons around the core.Heat the butter in the frying pan, add the courgette ribbons, along with the chilli flakes, if using, and sauté for a few minutes until softened. Drain the pasta, reserving a little water in the pan, put the pasta back in the pan and mix in the crème fraîche and the rest of the lemon zest and juice, to taste. Stir in the courgette ribbons and meatballs. Serve hot.",
    ...
    diffFoods[Math.floor(Math.random() * diffFoods.length)]
